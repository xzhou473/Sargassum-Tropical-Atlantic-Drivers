...
# over the follwing area 
	...
	# Subset smaller area: select ONLY the points within the Bloom Contour obtained by the digitization
	
	cp ../utils/mask_bloom.dat .
	
	cdo maskregion,mask_bloom.dat mlt_1-12deg_1993-2022_F64_masked_des.nc mlt_1-12deg_1993-2022_F64_masked_des_BLOOM-AREA.nc

	# Space average over smaller area: THE RESULTING TIMESERIES IS THE INPUT MLT FOR THE NL REGRESSION MODEL: 
	cdo fldmean mlt_1-12deg_1993-2022_F64_masked_des_BLOOM-AREA.nc fldm_of_1993_2022_glorys_mlt_BLOOM-AREA_masked_deseas_1-12deg.nc # <=== This is for NL regression model
...
# over the follwing area
        ...
        # Subset smaller area: BLOOM CONTOUR AREA ONLY                 
	cdo maskregion,mask_bloom.dat sst_1-12deg_1993-2022_F64_masked_des.nc sst_1-12deg_1993-2022_F64_masked_des_BLOOM-AREA.nc                                                           

	# Space average over smaller area: THE RESULTING TIMESERIES IS THE INPUT MLT FOR THE NL REGRESSION MODEL:      
	cdo fldmean sst_1-12deg_1993-2022_F64_masked_des_BLOOM-AREA.nc fldm_of_1993_2022_glorys_sst_BLOOM-AREA_masked_deseas_1-12deg.nc # <=== In case you want the NonLinear Regression model over the bloom area only 
...
# ------------------------------------------------------
# Part C: Preliminary preprocessing of Dust data
# ------------------------------------------------------
...
# over the follwing area
	...
	# Select Area: BLOOM CONTOUR AREA ONLY
        cdo maskregion,mask_bloom.dat duaod550_f64_res075_2003-2022_GASB_deseas.nc duaod550_f64_res075_2003-2022_BLOOM-AREA_deseas.nc	
	...
	rm duaod550_f64_res075_2003-2022_GASB_deseas.nc
        ...
        cdo fldmean duaod550_f64_res075_2003-2022_BLOOM-AREA_deseas.nc fldm_of_duaod550_f64_res075_2003-2022_deseas_BLOOM-AREA.nc # <=== NL model input for dust
...
rm a 
 ...
 #  
# ------------------------------------------------------------------------------
# Also compute the trend of the deseasonalzied fields 
# over the whole available periods: Jan 1993- Nov 2024 for mlt and 2003-2022 for dust. 
# ------------------------------------------------------------------------------

# Remove seasonal cycle: 

# Compute trend of deseasonalized fields, over the whole periods:

#cp tmpfiles2/mlt_025deg_1993_01-2024_11_F64_masked_deseas.nc . 
#cp tmpfiles2/duaod550_f64_res075_2003-2022_GASB_deseas.nc .

#cdo trend mlt_025deg_1993_01-2024_11_F64_masked_deseas.nc a trendmap_mlt_1993-2024.nc
#cdo trend duaod550_f64_res075_2003-2022_GASB_deseas.nc a trendmap_duaod550_2003-2022.nc

#rm duaod550_f64_res075_2003-2022_GASB_deseas.nc
#rm mlt_025deg_1993_01-2024_11_F64_masked_deseas.nc
